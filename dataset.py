...
class Dataset(object):
    def __init__(self, dataset, flags):
        ...
        self.image_size = (400, 400)#(640, 640) if self.dataset == 'DRIVE' else (720, 720)
        self.ori_shape = (400, 400) #(584, 565) if self.dataset == 'DRIVE' else (605, 700)
        self.val_ratio = 0.1  # 10% of the training data are used as validation data
        self.train_dir = "/home/aditi/Documents/PhD/Steel_Refinement/Edge_Detection_CNNs/Proposed/edgan_proposed/V-GAN_WGAN_GP/data/{}/training/".format(self.dataset)
        self.test_dir = "/home/aditi/Documents/PhD/Steel_Refinement/Edge_Detection_CNNs/Proposed/edgan_proposed/V-GAN_WGAN_GP/data/{}/test/".format(self.dataset)
